...
import com.fm404.onair.core.navigation.impl.BroadcastNavigationContractImpl
...
object ScreenModule {
    ...
    @Provides
    @Singleton
    fun provideBroadcastNavigationContract(): BroadcastNavigationContract = BroadcastNavigationContractImpl()
