...
story_controller = StoryController(producer, story_service)
weather_service = WeatherService()
weather_controller = WeatherController(producer, weather_service)
news_service = NewsService()
news_controller = NewsController(producer, news_service)
