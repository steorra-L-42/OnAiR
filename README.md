...
### 📱작동 화면
| 1. 회원가입 | 2. 마이페이지 | 3. 채널 생성 | 4. 사연 전송 |
|---|---|---|---|
|전화번호 인증이 필수입니다.|프로필, 닉네임을 변경할 수 있어요|본인의 입맛에 맞게 바꿔보세요|AI DJ에게 사연을 보낼 수 있어요|
|<img src="" width="250"/>|<img src="" width="250"/>|<img src="" width="250"/>|<img src="" width="250"/>|

| 5. 사연 | 6. 날씨 | 7. 뉴스 | 8. 노래 | 
|---|---|---|---|
|사연이 채택되면 DJ가 읽어줘요|날씨를 읽어줘요|뉴스를 읽어줘요|본인이 설정한 플레이리스트에서 노래를 틀어줘요|
